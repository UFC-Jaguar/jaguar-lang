    ...
    public class FuncFun : Grammar {
        public AstInfo Rule(Parser parser) {
            ...
            if (parser.Current.Type == Consts.ARROW) {
                ...
                return ast.Success(new NoFuncFun(
                  var_name_tok,
